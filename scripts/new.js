...
const options = [
  {
    ...
    type: 'view',
    jsTemplate: 'View.js',
    jsDestPath: path.resolve('src/app/views/'),
    sassTemplate: 'View.scss',
    sassDestPath: path.resolve('src/scss/views/'),
    required: true,
  },
  {
    name: 'New Component',
    ...
    jsDestPath: path.resolve('src/app/components/'),
    sassTemplate: 'Component.scss',
    sassDestPath: path.resolve('src/scss/components/'),
    required: true,
  },
];
